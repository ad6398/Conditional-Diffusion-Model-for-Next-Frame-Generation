...
if __name__ == "__main__":
    ...
    train_data_path = os.path.join(data_path,'train/video_') #Change this to your train set path
    val_data_path = os.path.join(data_path,'val/video_') #Change this to your validation path
    ...
    for epoch in range(epochs):
        ...
        if avarage_loss < latest_loss:
            best_model = model
            torch.save(best_model, 'unet3.pt')
